package xyz.nokt.btf.sunmiprinter.utils;
...
import xyz.nokt.btf.sunmiprinter.R;
...
public class SunmiPrintHelper {
    ...
    public void printExample(Context context){
        ...
        try {
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_add_black);
            sunmiPrinterService.printBitmap(bitmap, null);
